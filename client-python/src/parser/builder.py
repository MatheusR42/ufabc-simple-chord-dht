...
def add_publish_command(parser: ArgumentParser, subparsers: _SubParsersAction):
    ...
    publish_parser.add_argument('--messages', required=True, help='Messages to publish')
    publish_parser.add_argument('--bytes', action='store_true', help='If present, the messages string will be converted to bytes')
